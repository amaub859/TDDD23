	...
	function onCollision(self, e)
		...
		if mydata.score >= 3 then
			...
			for i=1,#mydata.star do
				if mydata.star[i] == "star1" then
					bool = true
				end
			end
			if bool == false then
				table.insert(mydata.star, "star1")
			end
			...
			if mydata.reload < 2 then
				...
				star2.alpha = 0
				for i=1,#mydata.star do
					if mydata.star[i] == "star2" then
						bool = true
					end
				end
				if bool == false then
					table.insert(mydata.star, "star2")
				end
			end
			...
			if mydata.collision < 10 then
				...
				star3.alpha = 0
				for i=1,#mydata.star do
					if mydata.star[i] == "star3" then
						bool = true
					end
				end
				if bool == false then
					table.insert(mydata.star, "star3")
				end
			end
			---------------------------------------
