...
local numOfStaticObject = 4
local numOfMovingObject = 0
local numOfGravityTarget = 1
local anim

local lvlShots = 1
local lvlCollisions = 8
local lvlMonsters = 3
mydata.lvl = 4
local lvlNext = 5
